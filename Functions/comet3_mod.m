...
if nargs == 5, [x,y,z,p,delayt] = deal(args{:}); end
...
body = animatedline('parent',ax,'color',colors(2,:),'linestyle',lstyle,...
                    'Marker',mrkstyle,'MaximumNumPoints',max(1,k),'Tag','body');
tail = animatedline('parent',ax,'color',colors(3,:),'linestyle','--','Marker',mrkstyle,...
